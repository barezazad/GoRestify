...
// Zero consts, to make computations faster.
...
//
// For slightly faster conversion, use NewFromFloatWithExponent where you can specify the precision in absolute pkg_terms.
//
