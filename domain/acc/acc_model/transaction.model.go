...
// TransactionTable is the ledger header table.
// Name is historically "base_transactions" (not acc_transactions); kept for compatibility.
const (
	TransactionTable = "base_transactions"
)

// Transaction model — header for a posted money movement (immutable after DoTransaction).
type Transaction struct {
	...
	Hash        string           `gorm:"uniqueIndex:idx_transaction_hash;type:varchar(70);" json:"hash,omitempty" bind:""`
