...
// GetAll returns all currencies without filter, order, or pagination
func (r *CurrencyRepo) GetAll() (currencies []acc_model.Currency, err error) {
	err = r.Engine.DB.Table(acc_model.CurrencyTable).Find(&currencies).Error
