...
// GetAll returns all regions without filter, order, or pagination
func (r *RegionRepo) GetAll() (regions []base_model.Region, err error) {
	err = r.Engine.DB.Table(base_model.RegionTable).Find(&regions).Error
