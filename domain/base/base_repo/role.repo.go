...
// GetAll returns all roles without filter, order, or pagination
func (r *RoleRepo) GetAll() (roles []base_model.Role, err error) {
	err = r.Engine.DB.Table(base_model.RoleTable).Find(&roles).Error
