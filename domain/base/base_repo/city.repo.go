...
// GetAll returns all cities without filter, order, or pagination
func (r *CityRepo) GetAll() (cities []base_model.City, err error) {
	err = r.Engine.DB.Table(base_model.CityTable).Find(&cities).Error
