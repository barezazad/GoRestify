...
// GetAll returns all users without filter, order, or pagination
func (r *UserRepo) GetAll() (users []base_model.User, err error) {
	err = r.Engine.DB.Table(base_model.UserTable).Find(&users).Error
